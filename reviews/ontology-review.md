...
Questo documento registra l'audit normativo del nucleo rispetto a [`schema.md`](../specification/schema.md), [`metamodello.md`](../specification/metamodello.md), [`relazioni.md`](../specification/relazioni.md) e [`lifecycle.md`](../specification/lifecycle.md).
...
- usare le relazioni normative di [`relazioni.md`](../specification/relazioni.md), in particolare `abilita`, `limita`, `trasforma`, `produce`, `esegue`, `supporta`, `seleziona`, `soddisfa`, `viola`, `contribuisce_a`, `mitiga` e `compensa`;
